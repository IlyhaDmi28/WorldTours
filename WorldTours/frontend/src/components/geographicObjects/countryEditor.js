...
function CountryEditor({indexOfSelectedCountry, countries, setCountries, closeModal}) {
    console.log(indexOfSelectedRoute);
    const [country, setCountry] = useState(indexOfSelectedCountry !== -1 ? countries[indexOfSelectedCountry] : {
        id: null,
        name: null,
        imageUrl: null
    });
