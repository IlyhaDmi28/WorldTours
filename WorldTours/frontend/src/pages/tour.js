	...
	return (
		<div className="tour">
            ...
            <div className="tour-name-and-mark">
                <p><b>Место для ебли Андрея</b></p>
                <div style={{ backgroundColor: getBackgroundColorMark(4.2) }}><b>4.2</b></div>
            </div>
            ...
            <div className="tour-info-and-reservation">
                <div className="tour-info">
                    ...
                    <div className="tour-desription">
                        Лучший отель, бля, отвечаю нахуй. Рядом пляж, море. Там можно купаться, девачек кадрит. Вообщем, тур охуенейший.
                        Пиздуй сюда нахуй, нераздумывая!!!!!!!!!!!! ЧМПТАВОМИАВРМ ВАПОАВОПАВО ОВАОПАВОПАВОЛ СОПЛВОПЛАВОЛВО ВАЛПОАВЛПОАВЛ
                        ВАПВАП ПИАВПМВАМАВ ВАПАВПАВЬПВАОМОВАМО ВАОПАВПЛАВОЛМОВЛАЮ. ВШПОАВАОЫВОААВМИР ЫВРАВРЫАИРЫВ ЫВАИЫВОАЛЫИР ЫВАИЫВОАВЫ
                        ЫВАВЫИВЫОЛАВЫЛОТМВСМ  МТ!
                    </div>
